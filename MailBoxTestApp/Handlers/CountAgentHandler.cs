...
{
    internal class CountAgentHandler : IMessageHandler<Message>
    {
        ...
        public CountAgentHandler(string filePath)
        {
        ...
        protected virtual Task OnMessage(CountMessage msg, CancellationToken token)
        {
